<?php
 ...
 $name=$_POST['name'];
 $sql = "SELECT * FROM product,bags where name='$name'  OR catagory='$name'";
  ...
  <div class="container">
   ...
   <?php
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
          <div class="col-md-3 col-sm-6 col-6">
            <div>
              <img src="admin/cloth_img/<?php echo $row['imgname']; ?>"  width="" height="300" style="vertical-align:left" >
          ...
          <?php 
            ...
            echo "No results for your Searched Items";
        ?>
