...
<body>
	<section class="header" id="header">
		...
		<div class="line-fixed">Tachis Admin Panel</div>
		<?php
		$c=0;
		...
		<span style="border-radius: 200px;
	...
	<div class="sidenav" id="sidenav">
		<ul class="navbar-nav">
		   <li class="nav-item">
			...
			<li class="nav-item">
				<a class="nav-link ap" href="add_product.php">Add Bags</a>
			</li>
			 <li class="nav-item">
				<a class="nav-link po" href="add_cloth.php">Add Clothings</a>
			</li>
			<li class="nav-item">
				<a class="nav-link vp" href="all_product.php">All Bag Items</a>
			</li>
			<li class="nav-item">
				<a class="nav-link vp" href="all_cloth.php">All Clothing Items</a>
			</li>
			<li class="nav-item">
