...
if (isset($_POST['order_btn'])) {
  ...
  if (mysqli_num_rows($cart_query) > 0) {
    ...
    if ($flag == 0) {
      ...
      $detail_query = mysqli_query($conn, "INSERT INTO `orders`(userid, name, address, phone, totalproduct, totalprice, status) VALUES('$userid', '$name', '$address', '$number', '$total_product', '$price_total', '$status')") or die($conn->error);
...
<div class="container pendingbody">
    ...
    <tbody>
      ...
      ?>
          ...
          <tr>
            ...
            <td><span><a href="cart(1).php?remove=<?php echo $row['id']; ?>">Remove</a></span></td>
          </tr>
      <?php
        }
      } else
  ...
  <tbody>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
      ...
      <h5>Please fill in for contact information</h5>
